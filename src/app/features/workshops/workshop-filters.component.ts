    ...
    <div class="filters-container">
      ...
      <div class="filter-group">
        ...
        <div class="price-inputs">
          <input type="number" placeholder="Min" [(ngModel)]="filters.priceRange.min" (change)="onFilterChange()">
          <input type="number" placeholder="Max" [(ngModel)]="filters.priceRange.max" (change)="onFilterChange()">
        </div>
      </div>
