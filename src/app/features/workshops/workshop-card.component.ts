  ...
  template: `
    <div class="workshop-card">
      ...
      <div class="workshop-footer">
        ...
        <span class="participants">{{ workshop().currentParticipants }}/{{ workshop().maxParticipants }}</span>
      </div>
      <div class="workshop-actions">
        <button class="enroll-btn" (click)="onEnroll()" [disabled]="!canEnroll()">
          {{ getEnrollButtonText() }}
        </button>
        <button (click)="toggleReviews()" class="reviews-btn">{{ showReviews() ? 'Hide' : 'Show' }} Reviews</button>
      </div>
    </div>
