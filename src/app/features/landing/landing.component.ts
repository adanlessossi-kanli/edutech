...
export class LandingComponent {
  ...
  benefits: Benefit[] = [
    { icon: '🎓', title: 'Expert Instructors', description: 'Learn from professionals with real-world experience', action: 'instructors' },
    { icon: '⚡', title: 'Hands-On Learning', description: 'Build projects and gain practical skills', action: 'hands-on' },
    { icon: '🏆', title: 'Certificates', description: 'Earn recognized certifications upon completion', action: 'certificates' },
    { icon: '💼', title: 'Career Support', description: 'Get guidance to advance your career', action: 'career' },
    { icon: '🌐', title: 'Flexible Schedule', description: 'Learn at your own pace, anytime, anywhere', action: 'flexible' },
    { icon: '👥', title: 'Community', description: 'Connect with peers and build your network', action: 'community' }
  ];
